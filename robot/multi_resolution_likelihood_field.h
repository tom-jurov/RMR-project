...
// Include the header file that defines LaserMeasurement.

/// 多分辨率的似然场配准方法
class ROBOT_EXPORT MRLikelihoodField {
public:
    ...
    /// 设置匹配源
    void SetSourceScan(std::shared_ptr<LaserMeasurement> scan) { source_ = scan; }
